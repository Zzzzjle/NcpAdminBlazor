...
namespace NcpAdminBlazor.Client.Api.User.List
{
    ...
    public partial class ListRequestBuilder : BaseRequestBuilder
    {
        ...
        public ListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/user/list?pageIndex={pageIndex}&pageSize={pageSize}{&email*,phone*,realName*,username*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::NcpAdminBlazor.Client.Api.User.List.ListRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ListRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/user/list?pageIndex={pageIndex}&pageSize={pageSize}{&email*,phone*,realName*,username*}", rawUrl)
        {
        }
        /// <summary>
        /// 按条件分页查询用户
